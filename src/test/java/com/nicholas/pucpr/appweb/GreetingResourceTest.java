...
under the License.
 */
package com.nicholas.pucpr.appweb;
...
import com.nicholas.pucpr.appweb.jaxrs.config.JaxrsActivator;
import com.nicholas.pucpr.appweb.jaxrs.resources.PostResource;
...
public class GreetingResourceTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class)
                ...
                .addClasses(PostResource.class, JaxrsActivator.class)
